...
const Calendar = ({
  ...
  <DayPicker
    ...
    classNames={{
      ...
      nav_button: cn(
        'h-7 w-7 bg-transparent p-0 border flex justify-center items-center rounded-md opacity-50 hover:opacity-100',
        icon === 'badge-check' ? 'border-none' : 'border-primary'
      ),
      ...
      day_selected:
        'bg-primary text-primary-foreground rounded-sm hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground',
    ...
    components={{
      IconLeft: props => (
        <>
          {icon === 'badge-check' ? (
            <BadgeCheckIcon {...props} className="h-4 w-4" />
          ) : (
