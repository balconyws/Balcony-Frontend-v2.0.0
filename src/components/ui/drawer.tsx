...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-x-0 bottom-0 z-50 mt-24 flex flex-col rounded-t-[25px] border bg-background box-shadow-sheet',
        className
      )}
      {...props}>
      <div className="mx-auto mt-3 mb-[30px] h-[5px] w-[200px] rounded-lg bg-[#F0F0F0]" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
));
