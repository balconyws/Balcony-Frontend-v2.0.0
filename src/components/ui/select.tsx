...
>(({ className, children, icon, error, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'flex h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus-visible:ring-offset-0 focus-visible:ring-transparent disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
      error &&
    ...
    <SelectPrimitive.Icon asChild>
      {icon ? icon : <ChevronsUpDownIcon className="text-primary w-3 h-3" />}
